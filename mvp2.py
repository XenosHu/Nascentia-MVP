...
def plot_ulcer_counts_by_month(ulcer):
    ...
    if time_grouping == 'Quarter':
        ...
        num_bars = st.slider('Choose the timeframe for display: ', min_value=1, max_value=len(type_counts_by_month['Quarter'])-default_num_bars+1, value=1)
        ...
        default_num_bars = min(len(type_counts_by_month), 12)
        num_bars = st.slider('Choose the timeframe for display: ', min_value=1, max_value=len(type_counts_by_month['Year'])-default_num_bars+1, value=1)
    else:  # Default to 'Month'
        default_num_bars = min(len(type_counts_by_month), 12)
        num_bars = st.slider('Choose the timeframe for display: ', min_value=1, max_value=len(type_counts_by_month['Month'])-default_num_bars+1, value=1)
...
def plot_severity_counts_by_month(brad):
    ...
    if time_grouping == 'Quarter':
        ...
        num_bars = st.slider('Choose the timeframe for display: ', min_value=1, max_value=len(severity_counts_by_month['Quarter'])-default_num_bars+1, value=1)
    elif time_grouping == 'Year':
        ...
        default_num_bars = min(len(severity_counts_by_month), 12)
        num_bars = st.slider('Choose the timeframe for display: ', min_value=1, max_value=len(severity_counts_by_month['Year'])-default_num_bars+1, value=1)
    else:  # Default to 'Month'
        default_num_bars = min(len(severity_counts_by_month), 12)
        num_bars = st.slider('Choose the timeframe for display: ', min_value=1, max_value=len(severity_counts_by_month['Month'])-default_num_bars+1, value=1)
